          ...
          <Button variant="ghost" size="sm" onClick={async () => {
            ...
            try {
              ...
              await generateIntakePDF(org as any, {
                ...
                clientFirstName: repair.clients?.first_name ?? undefined,
                clientLastName: repair.clients?.last_name ?? undefined,
                clientAddress: repair.clients?.address,
                clientPostalCode: repair.clients?.postal_code ?? undefined,
                clientCity: repair.clients?.city ?? undefined,
