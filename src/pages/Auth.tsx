    ...
    <div className="min-h-screen bg-background flex justify-center">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-8 sm:px-8 lg:px-16">
        ...
        <div className="w-full max-w-[400px]">
          ...
          {/* Google — official GIS button. Clicking it opens a popup showing
              the BonoitecPilot app name + logo from the OAuth consent screen. */}
          <div className="flex justify-center">
            <div ref={googleBtnContainer} className="flex justify-center" />
          </div>
          {/* Hidden fallback for when GIS fails to load (popup blocked, FedCM off, etc.) */}
          {!googleSignIn.ready && (
            <Button
              variant="outline"
