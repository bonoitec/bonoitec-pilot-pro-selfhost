...
CREATE POLICY "Org members can insert articles" ON public.articles FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update articles" ON public.articles FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view articles" ON public.articles FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Org members can manage deposit codes" ON public.deposit_codes FOR ALL TO authenticated
  USING (organization_id = get_user_org_id())
  WITH CHECK (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can manage device catalog" ON public.device_catalog FOR ALL TO authenticated
  USING (has_role(auth.uid(), 'admin'::app_role))
  WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can view device catalog" ON public.device_catalog FOR SELECT TO authenticated
  USING (true);
...
CREATE POLICY "Admins can delete devices" ON public.devices FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can insert devices" ON public.devices FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update devices" ON public.devices FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view devices" ON public.devices FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can delete inventory" ON public.inventory FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can insert inventory" ON public.inventory FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update inventory" ON public.inventory FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view inventory" ON public.inventory FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());

-- INVENTORY_PRICE_HISTORY
DROP POLICY IF EXISTS "Org members can insert price history" ON public.inventory_price_history;
DROP POLICY IF EXISTS "Org members can view price history" ON public.inventory_price_history;

CREATE POLICY "Org members can insert price history" ON public.inventory_price_history FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can view price history" ON public.inventory_price_history FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Org members can insert invoices" ON public.invoices FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update invoices" ON public.invoices FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Org members can insert notification logs" ON public.notification_logs FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can view notification logs" ON public.notification_logs FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can delete notification templates" ON public.notification_templates FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins can insert notification templates" ON public.notification_templates FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins can update notification templates" ON public.notification_templates FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can view notification templates" ON public.notification_templates FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can insert organization" ON public.organizations FOR INSERT TO authenticated
  WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins can update own organization" ON public.organizations FOR UPDATE TO authenticated
  USING (id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can view organization" ON public.organizations FOR SELECT TO authenticated
...
CREATE POLICY "Users can update own profile" ON public.profiles FOR UPDATE TO authenticated
  ...
  WITH CHECK (user_id = auth.uid() AND organization_id = get_user_org_id());
CREATE POLICY "Users can view profiles in own org" ON public.profiles FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can delete quotes" ON public.quotes FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can insert quotes" ON public.quotes FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update quotes" ON public.quotes FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view quotes" ON public.quotes FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Org members can insert repair messages" ON public.repair_messages FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update repair messages" ON public.repair_messages FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view repair messages" ON public.repair_messages FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can delete templates" ON public.repair_templates FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone authenticated can view public templates" ON public.repair_templates FOR SELECT TO authenticated
  USING (is_public = true OR organization_id = get_user_org_id());
CREATE POLICY "Org members can insert templates" ON public.repair_templates FOR INSERT TO authenticated
  WITH CHECK (
    organization_id = get_user_org_id()
    AND (created_by = auth.uid() OR created_by IS NULL)
    AND (is_public = false OR has_role(auth.uid(), 'admin'::app_role))
  );
CREATE POLICY "Org members can update own templates" ON public.repair_templates FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id())
  WITH CHECK (
    organization_id = get_user_org_id()
...
CREATE POLICY "Admins can delete repairs" ON public.repairs FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can insert repairs" ON public.repairs FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update repairs" ON public.repairs FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view repairs" ON public.repairs FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can delete services" ON public.services FOR DELETE TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can insert services" ON public.services FOR INSERT TO authenticated
  WITH CHECK (organization_id = get_user_org_id());
CREATE POLICY "Org members can update services" ON public.services FOR UPDATE TO authenticated
  USING (organization_id = get_user_org_id());
CREATE POLICY "Org members can view services" ON public.services FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
...
CREATE POLICY "Admins can manage technicians" ON public.technicians FOR ALL TO authenticated
  USING (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role))
  WITH CHECK (organization_id = get_user_org_id() AND has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Org members can view technicians" ON public.technicians FOR SELECT TO authenticated
  USING (organization_id = get_user_org_id());
